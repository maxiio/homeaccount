...
/*    	String myEmailAccount = "17798531336@163.com";
    	String myEmailPassword = "zt1147887547";*/
     	String myEmailAccount = "1534479537@qq.com";
    	String myEmailPassword = "ziuutqoxxwrnjebe";
...
//    	 收件人邮箱（替换为自己知道的有效邮箱）
//    	String receiveMailAccount = "1534479537@qq.com";
        ...
        message.setFrom(new InternetAddress(myEmailAccount, "家庭记账系统", "UTF-8"));
...
public static void main(String[] args) throws Exception {
	MainMail.sendMyEMail("javazt@126.com", "zoutong", "66666666");
}
