...
$(function () {
	...
	$.post("${pageContext.request.contextPath}/OutAccountAction_findOutAccountGroupByOutAccountTypeName.action",{},function(data){
    	$('#bing').highcharts({
       	 chart: {
    ...
    $("#selectYear").change(function(){
    	...
    	$.post("${pageContext.request.contextPath}/OutAccountAction_findOutAccountGroupByOutAccountTypeName.action",{"year":year},function(data){
        	$('#bing').highcharts({
           	 chart: {
                    plotBackgroundColor: null,
                    plotBorderWidth: null,
