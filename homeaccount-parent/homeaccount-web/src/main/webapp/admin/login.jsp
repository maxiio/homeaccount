...
<body>
	<div
		...
		<span style="float: right; margin-top: 35px; color: #488ED5;">家庭记账系统后台管理，致力于便捷、安全、稳定等方面的客户体验</span>
	</div>
	<div class="main-inner" id="mainCnt"
		style="width: 900px; height: 440px; overflow: hidden; position: absolute; left: 50%; top: 50%; margin-left: -450px; margin-top: -220px; background-image: url('${pageContext.request.contextPath }/img/admin_bg.jpg')">
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				...
				<form id="loginform" name="loginform" method="post" class="niceform"
					action="${ pageContext.request.contextPath }/ManagerAction_login.action">
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						style="margin-top: 5px;">
						<input id="loginform:idInput" type="text" name="manager_name"
					...
					<div id="pwdInputLine" class="loginFormIpt showPlaceholder">
						<input id="loginform:pwdInput" class="loginFormTdIpt"
							type="password" name="manager_pwd" /> <label for="pwdInput"
	...
	<div
		...
		<span style="color: #488ED5;">Powered By www.javazt.top</span> <span
